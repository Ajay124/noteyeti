...
import DietExerciseService from "../../services/deitexercise";
...
class Add extends Component {
  ...
  retrieveDetail() {
    DietExerciseService.get(this.state.id)
      .then(response => {
  ...
  handleSubmit (event) {
    ...
    if (form.checkValidity() === false) {
      ...
      if ( this.state.id ) {
        ...
        DietExerciseService.update( this.state.id, formData )
        .then(response => {
        ...
        //   formData.append('img'+i, this.state.files[i]);
        // }
        DietExerciseService.create(formData)
        .then(response => {
            if ( response.data.status == false ) {
            toast.error(response.data.message);
            this.setState({ className : 'was-validated'  } );
  ...
  render() {
    ...
    let h3 = "Add New Diet or Exercise";
    let buttonTXT = 'Add';
    if ( id != undefined ) {
        h3 = "Update Diet or Exercise";
        buttonTXT = 'Update';
    }
    return (
        <React.Fragment>
                    ...
                    <div class="card bg-secondary shadow">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <Link to={"/diet-exercise"} className="btn btn-sm btn-primary">
                                    Diet/Exercise List
                                </Link>
                            </div>
                        </div>
                                          ...
                                          <div class="col-lg-3">
                                              <div class="form-group">
                                                  ...
                                                  <select required name="type" onChange={this.handleChange} class="form-control form-control-alternative">
                                                      ...
                                                      <option selected={this.state.type == '1' ? 'selected' : '' } value='1'>Diet</option>
                                                      <option selected={this.state.type == '2' ? 'selected' : '' }  value='2'>Exercise</option>
                                                  </select>
                                              </div>
                                          </div>
                                          {/* <div class="col-lg-6">
