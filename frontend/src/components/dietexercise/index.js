...
class Test extends Component {
  ...
  retrieveDosdonts() {
    ...
    DietExerciseService.getAll(data)
      .then(response => {
        this.setState({
                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col-4">
                                    <h3 class="mb-0">Diet & Exercise List</h3>
                                </div>
                                {/* <div class="col-4">
                                ...
                                <div class="col-8 text-right">
                                    <Link to={"/add-diet-exercise"} className="btn btn-sm btn-primary">
                                        Add New
                                    </Link>
                                </div>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <div class="dropdown">
                                            ...
                                            <Link to={"/add-diet-exercise/"+test.dd_uuid} className="">
